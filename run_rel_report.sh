...
echo 'intropolis_sample_id	SRR	in_sarvens_samples	REL Sense Frac	REL Total Frac	REL Cov Frac	REL Spot Frac	RELSense count	REL count	REL count	Total count	Rel Cov	Total Cov	spots	bases	read_length	paired	platform_parameters	library_strategy	library_source	library_selection	library_name	cell_type	tissue	cell_line	strain	age	disease	library_construction_protocol' >sra_sarven_REL_report_by_sample_counts.sorted.tsv
