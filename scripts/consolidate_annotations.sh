...
perl /data/gigatron/snaptron/scripts/consolidate_gene_annotation.pl all_3_before_consolidation_sources.gtf.sorted | sort -t'	' -s -k1,1 -k4,4n -k5,5n | bgzip > gensemrefg.hg19_annotations.sorted.gtf.gz
