...
#create and load main Snaptron junctions DB
...
#create and load transcript DB for gene annotation coordinate lookups
sqlite3 transcripts.sqlite "CREATE TABLE transcript (chrom varchar(20) NOT NULL,source varchar(256) NOT NULL,type varchar(256) NOT NULL,start int(11) NOT NULL,end int(11) NOT NULL,unused1 varchar(20) DEFAULT NULL,strand char(1) NOT NULL,unused2 varchar(20) DEFAULT NULL,info LONGTEXT NOT NULL);"

zcat $3 > ./import  &
sqlite3 transcripts.sqlite -cmd '.separator "\t"' ".import ./import transcript"

sqlite3 transcripts.sqlite "CREATE INDEX tran_chrom_start_end_idx ON transcript(chrom,start,end);"
